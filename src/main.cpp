...
confuse = 89, bind = 90, poison = 91, slow = 92, stop = 93, stopra = 94, stopga = 95, sleep = 96, groupCure = 97, groupCura = 98, groupCuraga = 99,
...
const int commandFormulae[296][8] = {{aerialSlam, aero, 3, fireSurge, 3, 100, tva, c}, {aerialSlam, aerora, 3, fireStrike, 3, 90, tva, b},
{aerialSlam, highJump, 3, fireDash, 3, 100, tva, 9}, {aeroga, aero, 3, aerora, 3, 90, tva, 5}, {aeroga, aerora, 3, aerora, 3, 90, tva, 6},
